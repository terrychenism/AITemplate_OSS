...
{% endif %}
  ...
  TensorNHWC layout_A(i32_in_ch, i32_in_w * i32_in_ch, i32_in_h * i32_in_w * i32_in_ch );
{% if is_depthwise%}
  TensorNHWC layout_B(1, i32_kernel_w, i32_kernel_h * i32_kernel_w);
{% elif is_transpose %}
  TensorNHWC layout_B(i32_out_ch, i32_kernel_w * i32_out_ch, i32_kernel_h * i32_kernel_w * i32_out_ch );
{% else %}
  TensorNHWC layout_B(i32_in_ch, i32_kernel_w * i32_in_ch, i32_kernel_h * i32_kernel_w * i32_in_ch );
{% endif %}
  TensorNHWC layout_C(i32_out_ch, i32_out_w * i32_out_ch, i32_out_h * i32_out_w * i32_out_ch );
